...
if __name__ == "__main__":
    setup(name = "Orange Bioinformatics",
          ...
          py_modules = ['obiKEGG', 'obiGsea', 'obiGeneMatch', 'obiData', 'obiGenomicsUpdate', 'stats', 'pstat', 'obiExpression', 'obiGO', 'obiProb', 'obiAssess', 'obiGeneSets', 'obiMeSH', 'obiDicty', 'obiTaxonomy', 'obiChem', 'obiGene', 'obiGEO' ],

"""
<name>Structured Data Files</name>
<description>Reads data sets from designated directory.</description>
...
class DataStructure(orange.Orange):
...
class Selector(orange.Orange):
    """Structure for selection of examples: (selectorName, [0,1,...])
    """
    pass


class OWStructuredData(OWWidget):
    settingsList  = ["recentDirs","selectedDirName", "applyOnChange"]

    def __init__(self, parent=None, signalManager = None):
        OWWidget.__init__(self, parent, signalManager, 'Structured Data Files')
